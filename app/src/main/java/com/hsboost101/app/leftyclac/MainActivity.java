...
import com.hsboost101.app.leftyclac.InputItem.InputType;
        ...
        if (mInputList.size() > 1 && index >= 0 && index < mInputList.size())
            for (int i = index; i < mInputList.size(); i++) {
                ...
                if (getResources().getString(R.string.divide).equals(item.getInput())
                    ...
                    int a, b;
                    double c, d;
                    int size_a = mInputList.get(i - 1).getInput().length();
                    int size_b = mInputList.get(i + 1).getInput().length();

                    if (mInputList.get(i - 1).getType() == InputItem.InputType.INT_TYPE && size_a < 5) {
                        a = Integer.parseInt(mInputList.get(i - 1).getInput());
                        if (mInputList.get(i + 1).getType() == InputItem.InputType.INT_TYPE && size_b < 5) {
        ...
        if (mInputList.size() > 1 && index >= 0 && index < mInputList.size())
            for (int i = index; i < mInputList.size(); i++) {
                ...
                if (getResources().getString(R.string.sub).equals(item.getInput())
                    ...
                    int size_a = mInputList.get(i - 1).getInput().length();
                    int size_b = mInputList.get(i + 1).getInput().length();
                    if (mInputList.get(i - 1).getType() == InputItem.InputType.INT_TYPE && size_a < 10) {
                        a = Integer.parseInt(mInputList.get(i - 1).getInput());
                        if (mInputList.get(i + 1).getType() == InputItem.InputType.INT_TYPE && size_b < 10) {
                            b = Integer.parseInt(mInputList.get(i + 1).getInput());
